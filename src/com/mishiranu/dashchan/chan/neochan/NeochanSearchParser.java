...
public class NeochanSearchParser {
	private final String source;
	private final NeochanChanLocator locator;
	...
	public NeochanSearchParser(String source, Object linked) {
		this.source = source;
		locator = NeochanChanLocator.get(linked);
	}
	...
	private static final TemplateParser<NeochanSearchParser> PARSER = TemplateParser.<NeochanSearchParser>builder()
