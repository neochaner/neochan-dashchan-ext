...
public class NeochanChanConfiguration extends ChanConfiguration {
	...
	private static final String KEY_MAX_IMAGES = "max_images";


	public NeochanChanConfiguration() {
	...
	public Posting obtainPostingConfiguration(String boardName, boolean newThread) {
		...
		posting.allowSubject = false;
		posting.optionSage = true;
		posting.attachmentCount = get(boardName, KEY_MAX_IMAGES, 4);
	...
	public boolean isTagSupported(String boardName, int tag) {
		if (tag == NeochanChanMarkup.TAG_CODE) {
	...
	public void updateFromBoardJson(String boardName, JSONObject jsonObject, boolean updateTitle) {
		...
		String defaultName = CommonUtils.optJsonString(jsonObject, "Аноним");
		int bumpLimit = jsonObject.optInt("reply_limit");
		int maxImages = jsonObject.optInt(KEY_MAX_IMAGES);
		...
		set(boardName, KEY_MAX_IMAGES, maxImages);
	}
}
